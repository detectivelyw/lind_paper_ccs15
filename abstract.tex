...
OSes to allow secure computation of programs. \yanyan{why legacy 
code, not new code too?} \yiwen{I agree that it should be more than just legacy code.} 
...
paths contain fewer vulnerabilities than other parts of the kernel.  
\yanyan{than, eg, using uncommon paths.}
...
that places only limited trust in the privileged code. 
